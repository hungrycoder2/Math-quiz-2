...
document.getElementById("player1_quetion").innerHTML = "Question Turn - " + player1_name;
...
remove_charAt2 = remove_charAt1.replace(charA2, "_");
remove_charAt3 = remove_charAt2.replace(charA3, "_");
console.log(remove_charAt3);
